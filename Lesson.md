...
In this lesson, we're going to inherit a UI component library built with the React, styled-components, PropTypes, and Storybook JavaScript libraries, and step through how to build and document a React UI component so other developers know how to use it.
